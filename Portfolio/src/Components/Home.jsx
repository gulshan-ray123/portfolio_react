...
function Home() {
  ...
  return (
    ...
    <div>
      <div className="flex justify-center h-[610px]  md:flex md:justify-end mr-20">
      ...
      <span className="h-[340px] w-[290px] border-green-800 drop-shadow-2xl block bg-[url('gulshan_preview_rev_1.png')] bg-cover md:hidden"></span>
      <div className= "h-[400px] w-[400px] mr-20 mt-24 hidden md:bg-sky-500 rounded-[50%] md:block bg-[url('gulshan_preview_rev_1.png')] bg-cover hover:shadow-2xl hover:border-2 hover: border-yellow-600"></div>
      </div> 
